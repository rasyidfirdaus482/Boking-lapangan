...
if (isset($_POST['submit'])) {
    ...
    if ($result_update_booking === false) {
        ...
        header("Location: profiluser.php?message=Data pemesanan berhasil diupdate.");
        exit();
    }
}
?>
    ...
    <form action="" method="post">
        ...
        <p>
            ...
            <select name="jenis_lapangan" id="jenis_lapangan" required>
                <option value="A" <?php if ($jenis_lapangan == "A") echo "selected"; ?>>Lapangan A</option>
                <option value="B" <?php if ($jenis_lapangan == "B") echo "selected"; ?>>Lapangan B</option>
